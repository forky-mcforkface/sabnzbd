...
SKIN_TEXT = {
    ...
    # Config->Sorting
    "button-addSorter": TT("Add Sorter"),
    "selectOneCat": TT("Select at least 1 category."),
    "seriesSorting": TT("Series Sorting"),
    "opt-tvsort": TT("Enable TV Sorting"),
    "sort-enable": TT("Enable"),
    "sort-type": TT("Type"),
    "generalSorting": TT("General"),
    "explain-sorting_type": TT("Improve sorting by setting the expected type of jobs in the selected categories."),
